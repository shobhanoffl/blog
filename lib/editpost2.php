...
<form method="POST" action="editpost2.php">
  <label for="title">Title:</label><br>
  <input type="text" name="title" placeholder="Enter your blog title" size="80" class="form-control" autocomplete="off" value="<?php echo $title7[0] ?>"><br>
  
  <label for="subtitle">Subtitle:</label><br>
  <input type="text" name="subtitle" placeholder="Enter your blog Subtitle" size="80" class="form-control" autocomplete="off" value="<?php echo $subtitle7[0] ?>"><br>
  
  <label for="img">Image Link:</label><br>
  <input type="text" name="img" placeholder="Enter the Image Link" size="80" class="form-control" autocomplete="off" value="<?php echo $img7[0] ?>"><br>
  ...
  <input type="text" name="sources" placeholder="Enter the sources you referred" size="80" class="form-control" autocomplete="off" value="<?php echo $sources7[0] ?>"><br>
  
  <label for="links">Links: </label><small style="color:#999999;"> &nbsp;&nbsp;&nbsp;&nbsp;'https://' already included</small><br>
  <input type="text" name="links" placeholder="Enter the links for referrence" size="80" class="form-control" autocomplete="off" value="<?php echo $links7[0] ?>"><br>
  
  <label for="tags">Tags:</label><br>
  <input type="text" name="tags" placeholder="Enter the Tags" size="80" class="form-control" autocomplete="off" value="<?php echo $tags7[0] ?>"><br>

  <label for="pgofblog">Page of Blog:</label><br>
  <input type="text" name="pgofblog" placeholder="Enter the Page of Blog" size="80" class="form-control" autocomplete="off" value="<?php echo $pgofblog7[0] ?>"><br>

  <label for="bno">Blog Number:</label><br>
  <input type="text" name="bno" size="80" class="form-control" autocomplete="off" value="<?php echo $bno7[0] ?>" readonly><br>  

  <input class="btn btn-primary" type="submit" name="editblog_btn" value="Update">
</form>
</div>
<div style="width:10%;float:left;"><br></div>
