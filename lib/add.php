...
if(isset($_POST['addblog_btn'])){
  ...
  $pgofblog=mysqli_real_escape_string($db, $_POST['pgofblog']);
  ...
  $date=date("d/m/Y");
  $time=date("H:i:s");
  $addblog_query = "INSERT INTO blogs (title,subtitle,img,content,sources,date,time,author,links,tags,pgofblog) VALUES('$title','$subtitle','$img','$editor','$sources','$date','$time','$author','$links','$tags','$pgofblog')";
