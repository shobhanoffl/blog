                ...
                <div class="tm-header-inner">
                    ...
                    <nav class="navbar tm-main-nav">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            ...
                            <?php endforeach ?>
                            <li class="nav-item">
                            <a href="./login.php" class="nav-link"><i class="fa fa-users"></i>Login/Signup</a>
                            </li>
                            </ul>                        
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-xs-center">
                        ...
                        <p class="sho-post-post"><?php echo $content[0]; ?></p><br><br>
                        <hr>
                        <small style="color:black; float:left; padding-top:45px;">Sources Referred: &nbsp;<b class="sho-small">
                        <?php
